...
public class StudentAdmissionController {
	...
	public ModelAndView submitAdmissionForm(@RequestParam Map<String, String> map){
		...
		String hobby=map.get("studentHobby");
		
		ModelAndView mv= new ModelAndView("SubmitForm");
		mv.addObject("msg", "Your Name is :  "+ name);
		mv.addObject("ms", "Your Hobby is :  "+ hobby);
		return mv;
	}
*/
	
	/*@RequestMapping(value="/submitAdmissionForm.html", method=RequestMethod.POST)
	public ModelAndView submitAdmissionForm(@RequestParam (value="studentName", defaultValue="Joya") String name, @RequestParam ("studentHobby" ) String hobby){
